...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DATA_32" -parent ${Page_0}
...
proc update_PARAM_VALUE.DATA_32 { PARAM_VALUE.DATA_32 } {
	# Procedure called to update DATA_32 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DATA_32 { PARAM_VALUE.DATA_32 } {
	# Procedure called to validate DATA_32
	return true
}
...
proc update_MODELPARAM_VALUE.DATA_32 { MODELPARAM_VALUE.DATA_32 PARAM_VALUE.DATA_32 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DATA_32}] ${MODELPARAM_VALUE.DATA_32}
}
