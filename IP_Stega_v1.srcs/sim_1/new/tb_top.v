...
module tb_top;
    parameter DATA_W = 64;
    parameter NUM_SAMPLES = 101; 
    
    reg i_clk, i_rst_n;
    reg s_axis_tvalid0;
    reg s_axis_tvalid1;
    reg [64-1:0] s_axis_tdata0;
    reg [128-1:0] s_axis_tdata1;
    wire s_axis_tready;
    wire m_axis_tvalid;
    wire m_axis_tlast;
    ...
    top #(.DATA_W(DATA_W)) top_inst (
        ...
        .s_axis_tvalid0(s_axis_tvalid0), .s_axis_tdata0(s_axis_tdata0), 
        .s_axis_tvalid1(s_axis_tvalid1), .s_axis_tdata1(s_axis_tdata1), 
    ...
    initial begin
        ...
        for (img_idx = 0; img_idx < NUM_SAMPLES; img_idx = img_idx + 1) begin
            ...
            $swrite(file_path_in, "input/image_merge_1.hex");
    ...
    task send_data(input integer size, input integer type);
        ...
        begin
            ...
            while (k < size) begin
                ...
                case(type)
                    0: begin
                        s_axis_tdata0 <= mem_weights_dw[k];
                        s_axis_tvalid0 <= 1'b1;
                    end
                    1: begin
                        s_axis_tdata0 <= mem_weights_pw[k];
                        s_axis_tvalid0 <= 1'b1;
                    end
                    2: begin
                        s_axis_tdata0 <= mem_bias[k];
                        s_axis_tvalid0 <= 1'b1;
                    end
                    3: begin
                        s_axis_tdata1 <= mem_image[k];
                        s_axis_tvalid1 <= 1'b1;
                    end
                endcase
