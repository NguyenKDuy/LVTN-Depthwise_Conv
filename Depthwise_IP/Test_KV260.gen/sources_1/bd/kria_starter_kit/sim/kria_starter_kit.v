...
module kria_starter_kit
   (fan_en_b,
    ...
    pmod_gpio_tri_t);
  output [0:0]fan_en_b;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 pmod_gpio TRI_I" *) (* X_INTERFACE_MODE = "Master" *) input [7:0]pmod_gpio_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 pmod_gpio TRI_O" *) output [7:0]pmod_gpio_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 pmod_gpio TRI_T" *) output [7:0]pmod_gpio_tri_t;
  ...
  wire [0:0]fan_en_b;
  wire [7:0]pmod_gpio_tri_i;
  wire [7:0]pmod_gpio_tri_o;
  wire [7:0]pmod_gpio_tri_t;
  ...
  kria_starter_kit_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  kria_starter_kit_axi_bram_ctrl_0_bram_0 axi_bram_ctrl_0_bram
  ...
  kria_starter_kit_axi_gpio_0_0 axi_gpio_0
       (.gpio_io_i(pmod_gpio_tri_i),
        .gpio_io_o(pmod_gpio_tri_o),
        .gpio_io_t(pmod_gpio_tri_t),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  kria_starter_kit_axi_smc_0 axi_smc
