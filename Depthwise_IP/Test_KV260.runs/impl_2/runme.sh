...
HD_PWD='D:/Depthwise_IP/LVTN-Depthwise_Conv/Depthwise_IP/Test_KV260.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Depthwise_Core_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Depthwise_Core_Top.tcl -notrace
