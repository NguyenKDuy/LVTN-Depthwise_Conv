...
// Pipeline: 3 stage
//   Stage 0 : Input Register   - c?t net d�i 192-bit �?u v�o
//   Stage 1 : Addition         - 12 ph�p c?ng 16-bit song song
...
module adder_tree #(
    ...
    // M?c ��ch: ��ng g�i 192-bit bus g?n ngu?n, tr�nh net d�i �?n 12 adder
    // =========================================================================
...
//            end
    ...
    // =========================================================================
    // Stage 1 - Addition  (12 ph�p c?ng song song, m?i ph�p 16-bit ? 17-bit)
    // =========================================================================
...
//                end
    ...
    always @(posedge i_clk) begin
        if (!i_rst_n) begin
            ...
            o_vld <= vld_s1; // o_vld tr? ��ng 3 cycle so v?i i_vld
//            if (vld_s1) begin
